...
always @(posedge clk_i or negedge rst_i)begin
    ...
    begin
        ...
        else if(fsm_state == STATE_LEVEL_FIRST)
        begin
            if(pte_errow_i || !resp_data_i[PAGE_VALID])
            begin
                pte_addr_r  <= 32'b0;
                pte_value_r <= 32'b0;
        ...
        else if(fsm_state == STATE_LEVEL_SECOND)
        begin
            if(pte_errow_i || !resp_data_i[PAGE_VALID])
            begin
                pte_addr_r  <= 32'b0;
