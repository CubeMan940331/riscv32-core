...
assign mmu_dcache_rd_o = mmu_dcache_rd_i && dcache_valid_o;
assign mmu_dcache_wr_o = mmu_dcache_wr_i && dcache_valid_o;

assign dcache_valid_o = dcache_mmu_available_i && (dcache_rd_r || dcache_wr_r);
